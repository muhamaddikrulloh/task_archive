...
<body class="bg-gray-100 min-h-screen">
  ...
  <nav class="bg-white shadow-sm px-6 py-4 flex items-center justify-between">
    ...
    <div class="flex items-center gap-6">
      <a href="dashboard.php" class="text-sm font-medium text-blue-600">Dashboard</a>
      <a href="tugas/main.php" class="text-sm text-gray-600 hover:text-blue-600">Data Tugas</a>
